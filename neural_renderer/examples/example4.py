...
import glob
import sys
sys.path.insert(0,"/home/aniket/RRC/ICRA-20/neural_renderer/neural_renderer")
...
data_dir = '/home/aniket/RRC/ICRA-20/for_neural_renderer/test_nn_data'
...
def main():
    ...
    parser.add_argument('-io', '--filename_obj', type=str, default=os.path.join(data_dir, 'model.obj'))
    parser.add_argument('-ir', '--filename_ref', type=str, default=os.path.join(data_dir, '0050.png'))
    parser.add_argument('-or', '--filename_output', type=str, default=os.path.join(data_dir, '0050_result.gif'))
